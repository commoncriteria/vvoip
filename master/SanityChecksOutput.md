...
* Error: Detected dangling ref to 'fau-stg-ext-1'
        for a ref.
...
* Warning: Detected an empty _p_ element./Module[1]""/sec:Security_Requirements[1]""/base-pp[1]""/modified-sfrs[1]""/section[4]""/base-sfr-spec[1]""/description[1]""/h:p[2]""
